...
namespace Checkers
{
    public class CheckersMove
    {
        ...
        public CheckersPiece[] Jumped
        {
            get
            {
                return (CheckersPiece[])jumped.ToArray(typeof(CheckersPiece));
            }
        }
        ...
        public Point[] Path
        {
            get
            {
                return (Point[])path.ToArray(typeof(Point));
            }
        }
        ...
        public bool CanMove
        {
            get
            {
                return (!cannotMove) && (EnumMoves().Length != 0);
            }
        }
        ...
        public bool MustMove
        {
            get
            {
                return ((!Moved) || ((CanMove) && (!game.OptionalJumping)));
            }
        }
